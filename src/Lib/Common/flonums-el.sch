...
;
; $Id: flonums-el.sch 6062 2009-02-16 16:57:44Z will $
;
; 30 April 1999 / lth
;
; Flonum constructors and accessors for little-endian 32-bit architectures.
...
(define (float-sign f)
  (fxrshl (bytevector-like-ref f 11) 7))
