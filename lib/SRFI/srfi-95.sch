...
;;;
;;; $Id: srfi-95.sch 6215 2009-05-06 00:19:51Z will $
...
;;; clinger: 2009-04-29: modified for [Larceny] and to fix bugs

;(require 'array)                                            ; [Larceny]
;(require 'multiarg-apply)		; used in SORT       ; [Larceny]

(cond-expand (srfi-63))                                      ; [Larceny]

(define identity values)  ; bug in reference implementation? ; [Larceny]
