...
;;;
;;; $Id: %3a1.sls 6215 2009-05-06 00:19:51Z will $
;;;
...
;;;  - fixed portability problems (:optional, etc)
;;;  - fixed a bug in "list=": did not handle more than two lists correctly
;;;  - fixed a bug in delete-duplicates!: = proc was not optional
...
(library (srfi :1 lists)
  ...
  ;; FIXME: might want to import map and for-each (with renaming)
