...
;
; $Id: standard-C.imp.sch 6134 2009-03-14 17:26:03Z will $
;
...
;                                                          effect
  `((,name:CAR        1 car              #f            15 ,:car      ,:none #f)
    ...
    (.integer->char:trusted 1 integer->char #f         38 ,:immortal ,:none #f)
...
;   (--               1 --               #f            32 ,:immortal ,:none #t)
    ...
    (.string-length:str 1 ustring-length:str     #f        801 ,:immortal ,:none #f)
...
;   (rational?        1 rational?        #f            20 ,:immortal ,:none #f)
    ...
    (string?          1 ustring?          #f          800 ,:immortal ,:none #f)
    (string-length    1 ustring-length    #f          801 ,:immortal ,:none #f)
...
;    (*                2 *                ,stdc-imm?    63 ,:immortal ,:none #t)
    ...
    (make-string      2 make-ustring      #f          799 ,:dead     ,:none #f)
    (string-ref       2 ustring-ref       ,stdc-imm?  802 ,:string   ,:none #f)
    (string-set!      3 ustring-set!      ,stdc-imm?  803 ,:dead     ,:string #f)
...
(define $setrtn/jump                    ; setrtn/invoke      m,o
